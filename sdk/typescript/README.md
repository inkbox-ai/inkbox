...
if (connections.installationAvailable) {
  const invitation = await client.slack.createInvitation(identityId);
  // Open invitation.invitationUrl in the installer's browser.
}
