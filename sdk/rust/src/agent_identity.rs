...
use crate::a2a::{A2AContext, A2AContextPage, A2ATask, A2ATaskPage};
...
impl AgentIdentity {
    ...
    pub fn a2a_tasks(
        ...
        self.inkbox
            .a2a()
            .tasks(&self.agent_handle(), state, cursor, limit)
    }

    pub fn a2a_sent_tasks(
        &self,
        state: Option<&str>,
        cursor: Option<&str>,
        limit: Option<u32>,
        ...
        self.inkbox
            .a2a()
            .sent_tasks(&self.agent_handle(), state, cursor, limit)
    }
