...
from inkbox.contacts import (
    ...
    ContactAddressPermission,
    ContactAddressUpdate,
    ContactDecision,
    ContactCommunicationPolicy,
    ContactCommunicationPreview,
    ContactCommunicationPolicyPage,
    ContactVisibilityDecisions,
    ContactIdentityVisibilityDecisions,
    ContactVisibilityPolicy,
    ContactVisibilityResult,
    ContactPermissionSummary,
    ContactPermissionVisibility,
    ContactPermissionEffective,
