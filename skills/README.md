...
|-------|----------|-------------|
| **inkbox-python** | Python ≥ 3.11 | Agent signup, identities, email, phone, text, iMessage, contacts, notes, contact rules, vault, and webhooks using the `inkbox` Python SDK |
| **inkbox-ts** | TypeScript / Node ≥ 22 | Agent signup, identities, email, phone, text, iMessage, contacts, notes, contact rules, vault, and webhooks using the `@inkbox/sdk` TypeScript SDK |
